    ...
    <div id="pageEditBook">
        <div id="myModal" style="width: 350px; height: 200px">
            <form method="POST" id="uploadFile" action="" enctype="multipart/form-data">
                <p style="position: absolute; bottom: 150px;top: 30px;left: 60px">Можно загрузить файл весом до 4мб </p><br/>
        ...
        <div id="editingBook">
            <div class="form-wrap" style="height: 609px">
                ...
                <form:form id="formNewBook" cssStyle="background: white" modelAttribute="bookForm" method="post" action="">
                    <form:hidden path="urlImg" id="url" value="${pageContext.request.contextPath}/${bookForm.urlImg}" placeholder="${pageContext.request.contextPath}/${bookForm.urlImg}"/>
                    <div>
...
<script>
    ...
    function newAtt(name) {
        ...
        el.placeholder='${pageContext.request.contextPath}/resources/static/images/'+name;
        el.setAttribute('value','${pageContext.request.contextPath}/resources/static/images/'+name);
    }
</script>
<script>

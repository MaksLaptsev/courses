    ...
    <div id="listBooks">
        ...
        <div id="sort" style="position:absolute;left:800px;top:250px;width:245px;height:20px;z-index:0">
            ...
            <form name="sortMenu">
                <select name="sel" onChange="changeSort(document.sortMenu.sel)">
                    ...
                    <option title="Сортировка по названию" value="${clearUrl}?sort=username&ascending=true"><spring:message code="app.page.sort.byName"/> ↑</option>
                    <option title="Сортировка по названию" value="${clearUrl}?sort=username&ascending=false"><spring:message code="app.page.sort.byName"/> ↓</option>
                </select>
            </form>
            <script>
        ...
        <div id="divTable" style="position: absolute; top: 275px;left: 0px;width: 1000px">
            <table class="table">
                <tr>
                    <th width="20px">Id</th>
                    <th style="border-bottom: black"><spring:message code="app.admin.user.login"/></th>
                    <th style="border-bottom: black">Role</th>
                ...
                <c:forEach items="${pagedListHolder.pageList}" var="item">
                    <tr>
                        ...
                        <td style="border: none"><a title="<spring:message code="app.admin.editUser"/>" class="editUserr" data-id="${item.id}" onclick="location.href='${pageContext.request.contextPath}/admin/list/user?id=${item.id}'"><img src="${pageContext.request.contextPath}/resources/static/images/changeButton.png" alt="editing book" width="20px" height="20px"></a></td>
                    </tr>
                </c:forEach>
            </table>

        ...
        <%-- 1-Img, 0-Bio, 2-lookBio --%>
            <div id="myModal1" style="width: 350px; height: 200px">
                    <form method="POST" id="uploadFile1" action="" enctype="multipart/form-data">
                        ...
                        <input id="file1" type="file" name="file" style="visibility: hidden"/><br/><br/>
                        <input type="button" onclick="document.getElementById('file1').click()" value="<spring:message code="app.admin.upload.file"/>" style="position: absolute;top:90px;left: 30%;width: 120px"/>

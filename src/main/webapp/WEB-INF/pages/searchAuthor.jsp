...
<jsp:include page="${pageContext.request.contextPath}/WEB-INF/pages/index.jsp"/>
...
<div id="container">
    <div id="sort" style="position:absolute;left:750px;top:163px;width:245px;height:20px;z-index:0">
        <p style="position:absolute;left:1025px;top:163px;width:245px;height:20px;z-index:0"><spring:message code="app.page.sort"/>:</p>
        <form name="sortMenu">
    ...
    <div id="Html1" style="position:absolute;left:0px;top:193px;width:919px;height:623px;z-index:0">
        <c:if test="${pagedListHolder.pageList.size()<1}">
